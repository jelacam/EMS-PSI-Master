...
namespace UIClient.ViewModel
{
    public class DashboardViewModel : ViewModelBase
    {
        ...
        private void ChangeAlgorithmCommandExecute(object obj)
        {
            ...
            {
                CommonTrace.WriteTrace(CommonTrace.TraceError, "Error - Change Optimization Algorithm. Message: {0}; Exception type: {1}", te.Message, te.GetType());
                CommonTrace.WriteTrace(CommonTrace.TraceInfo, "Repeating request - Change Optimization Algorithm");
                ...
                {
                    CommonTrace.WriteTrace(CommonTrace.TraceError, "Error - Change Optimization Algorithm. Message: {0}; Exception type: {1}", e.Message, e.GetType());
                }
            }
            catch (Exception e)
            {
