...
namespace EMS.Services.CalculationEngineService.PubSub
{
    ...
    public class PublisherService : ICePubSubContract
    {
        ...
        ICePubSubCallbackContract callback = null;
        OptimizationResultEventHandler optimizationResultHandler = null;
        ...
        public void PublishOptimizationResults(float result)
        {
            ...
            e.OptimizationResult = result;
            e.Message = "Optimization result";
